...
export default function TopUpWithdrawScreen() {
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      // keep quiet: your UI can show errors if you want later
    } finally {
      setSubmitting(false);
    }
  };
    ...
    <SafeAreaView className="flex-1 bg-primary-100">
      ...
      >
        <View className="flex-1 px-4 pt-3" style={{ paddingBottom: BOTTOM }}>
          {/* SMALL SUMMARY CARD */}
          <View className="bg-primary-400 rounded-3xl p-5 border border-white/10">
          ...
          <CustomText size="sm" secondary className="mt-1 mb-5">
            {subtitle}
          </CustomText>
        ...
        <View className="absolute left-0 right-0 bottom-0 px-4 pb-8 pt-3 bg-primary-100 border-t border-white/10">
          <Button
